...
export default function StudentEditPage() {
    ...
    useEffect(() => {
        document.title = "Edit Student | Learning Platform"
    }, [])
    return (
                ...
                <div className="flex">
                    ...
                    <div className="w-2/3 ml-10">
                        ...
                        <div className="w-full flex justify-center mt-5">
                            <Image src={"/icons/check.svg"} className="mx-2" alt="Check" width={40} height={40} />
                            <Image src={"/icons/cancel.svg"} className="mx-2" alt="Check" width={40} height={40} />
                        </div>
                    </div>
                </div>
            </div>
