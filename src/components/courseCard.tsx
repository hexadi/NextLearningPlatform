...
export default function Card(props: { id: string, courseName: string, imageUrl: string, route: any }) {
    ...
    return (
        <div className="relative rounded-lg overflow-hidden aspect-square text-white hover:text-carrot-orange-600" onClick={() => router != null && router.push(`/dashboard/course/${props.id}`)}>
